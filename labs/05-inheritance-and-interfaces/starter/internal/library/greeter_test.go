...
// specification for Exercise 3: run `go test ./...` now, before
// touching greeter.go, and it won't even compile yet (Greet() isn't
// part of the Greeter interface until you add it). Implement Greeter,
// Kiosk.Greet, and Mascot.Greet until it passes.
package library
