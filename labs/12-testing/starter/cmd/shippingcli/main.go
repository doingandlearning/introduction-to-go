...
// can see it work outside of a test run. It compiles and runs
// regardless of how much of shipping_test.go is finished, since
// _test.go files are never part of a normal build.
package main
